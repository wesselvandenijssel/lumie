...
class Walker_Fold_Menu extends Walker {
	/**
	...
	public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0) {
		...
		// Start the <ul class="folded"> on top-level menu-items only
		if ($depth == 0 && ($args->visible_amount + 1) == $data_object->menu_order) {
			$output .= '<ul class="folded">';
		}
	...
	public function end_el(&$output, $data_object, $depth = 0, $args = null) {
		...
		// Count the top-level menu-items and close the <ul class="folded"> if this is the last item
		if ($data_object->menu_order > $args->visible_amount) {
			global $wp_query;
			...
			if ($top_level_elements == $data_object->menu_order) {
				$output .= "</ul>";
			}
		}
	}
