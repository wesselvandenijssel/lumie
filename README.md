# Base theme - WordPress Theme

![Logo](https://www.mbeffect.nl/wp-content/themes/mb-effect/library/images/logo-mb-effect-wit.svg)

This repository contains the WordPress base theme from [MB effect](https://www.mbeffect.nl/).
...
- [@arondelooijer](https://github.com/arondelooijer)
- [@wesselvandenijssel](https://github.com/wesselvandenijssel)
- [@avmosel](https://github.com/avmosel)
